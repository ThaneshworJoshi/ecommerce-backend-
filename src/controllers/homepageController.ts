...
import { HomepageData, Category, ProductsData, ApiResponse } from '@/types/homepage';

// Mock data structure matching your frontend expectations
const mockHomepageData: HomepageData = {
  categories: [
    {
      ...
      name: 'Toys',
      slug: 'toys',
      imageUrl: '/assets/accessories/cat-toy-set1.jpg',
      productCount: 5
    },
    {
      id: 2,
    ...
    },
    {
      ...
      name: 'Beds',
      slug: 'beds',
      imageUrl: '/assets/accessories/cat-bed-luxury.jpg',
      productCount: 5
    }
  ],
  productsData: {
  ...
  heroBanner: {
    ...
    media: {
      imageUrl: "/assets/herobanner-img.png",
      altText: "Premium pet accessories banner"
    }
  },
  featuredProducts: [
    {
...
export const getHomepageData = async (req: Request, res: Response): Promise<void> => {
  try {
    logger.info('Homepage data requested');
    
    // In a real application, you would fetch this data from your database
    // For now, we'll return mock data that matches your frontend expectations
...
export const getHomepageCategories = async (req: Request, res: Response): Promise<void> => {
  try {
    logger.info('Homepage categories requested');
    
    const response: ApiResponse<Category[]> = {
      success: true,
      message: 'Categories retrieved successfully',
      data: mockHomepageData.categories
    };
...
export const getHomepageProducts = async (req: Request, res: Response): Promise<void> => {
  try {
    logger.info('Homepage products requested');
    
    const response: ApiResponse<ProductsData> = {
      success: true,
      message: 'Products retrieved successfully',
      data: mockHomepageData.productsData
    };
